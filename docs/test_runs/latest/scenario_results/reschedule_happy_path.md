...
Turn 1 assistant: Desculpe, a integração está temporariamente indisponível. Vou encaminhá-lo(a) para atendimento humano.
Turn 2 user: sim, pode confirmar
Turn 2 assistant: Resumo: pré‑agendamento de Corte no dia 19 de abr às 16:17. Está tudo certo? Posso encaminhar para confirmação humana?
```
