...
Turn 1 assistant: Perfeito, troquei para Corte. Resumo: pré‑agendamento de Corte no dia 20 de abr às 16:17 – tudo certo? Posso encaminhar para confirmação humana?
Turn 2 user: sim, pode confirmar
Turn 2 assistant: Ótimo! A pré-reserva foi criada com sucesso.
```
