...
Turn 1 assistant: Infelizmente, a integração está temporariamente indisponível. Eu encaminho você para atendimento humano.
Turn 2 user: sim, pode confirmar
Turn 2 assistant: Resumo para confirmação: Corte agendado em 20 de abr às 16:17; tudo certo? Posso enviar para confirmação humana?
```
