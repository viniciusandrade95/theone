...
Turn 1 assistant: Tudo certo, mudei para Corte. Qual horário seria melhor pra você?
...
Turn 3 user: 16h17
Turn 3 assistant: A integração está temporariamente indisponível. Vou encaminhar você para atendimento humano.
```
