...
Turn 1 assistant: Tudo certo! Ajustei para Corte, qual horário prefere?
...
Turn 3 user: 16h17
Turn 3 assistant: Desculpe, a integração está temporariamente indisponível. Vou encaminhar você para um atendente humano.
```
