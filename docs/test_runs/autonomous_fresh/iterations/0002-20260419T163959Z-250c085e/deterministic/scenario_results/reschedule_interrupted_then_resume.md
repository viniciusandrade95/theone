...
Turn 1 assistant: Tudo certo, mudei para Corte. Qual horário prefere?
...
Turn 3 user: 16h17
Turn 3 assistant: A integração está indisponível no momento. Vou encaminhar seu pedido para atendimento humano.
```
