...
Turn 5 assistant: Não encontrei isso no guia deste negócio. Você quer que eu encaminhe para um atendente?
```

## Failures

- step 1: assertion_failure: expected status awaiting_confirmation, got response=ok workflow=blocked
- step 2: assertion_failure: expected status collecting, got response=ok workflow=None
...
- step 5: assertion_failure: expected status awaiting_confirmation, got response=ok workflow=None
- step 5: assertion_failure: expected route workflow, got rag
...
- step 5: assertion_failure: unexpected RAG route
