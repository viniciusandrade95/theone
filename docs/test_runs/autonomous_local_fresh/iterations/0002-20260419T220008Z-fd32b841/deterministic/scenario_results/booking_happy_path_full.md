...
- crm_verification_failure: CRM appointments query failed with status 400
...
{
  "status_code": 400,
  "raw_body": "{\"error\":\"VALIDATION_ERROR\",\"details\":{\"message\":\"Missing tenant header: X-Tenant-ID\"}}",
  "parsed_body": {
  ...
  "reasons": [
    "CRM appointments query failed with status 400"
  ],
  "status": "FAIL"
}
```
